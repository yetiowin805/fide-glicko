...
if __name__ == "__main__":
    ...
    for month in months:
        ...
        if args.scrape_fide == "y":
            ...
            print(f"python3 tournament_scraper.py --month {month}")
            os.system(f"python3 tournament_scraper.py --month {month}")

        print(f"python3 extract_tournament_data.py --month {month}")
        os.system(f"python3 extract_tournament_data.py --month {month}")
    ...
    for month in adj_months:
        print(f"python3 remove_duplicates.py --root_dir ./clean_numerical/{month}")
